  ...
  <div className={styles['pageContainer']}>
    ...
    <div className={styles['contentContainer']}>
      <div className={styles['landingColumn']}>
        <p>Why?</p>
        <p>
          In response to looming “climate catastrophe”, designers have increasingly sought out sustainable alternatives
          to oil-based materials and in order to not steal land from food production, agriculture leftovers have become
          prime resources for new material development.
        </p>
        <p>
      ...
      <div className={styles['landingColumn']}>
        <p>What?</p>
        <p>
          It’s with this awareness that the project Syntropic Material attempt to design regenerative production
          processes for traditional and innovative plant/animal based materials using agricultural leftovers from
          regenerative, polycultural, agroforestal agriculture.
        </p>
        <p>
          Investigating if this great innovation in the field of materials can open new possibilities for the
          development of polycultures, and vice versa, if the choices taken in designing polycultures can define new
          directions in new materials development.
        </p>
        <p>
      ...
      <div className={styles['landingColumn']}>
        ...
        <p>
          ...
          together the wisdom of traditional indegenous environmental practices with the tools of western science to
          solve the most pressing environmental problems.
        </p>
        <p>
          {' '}
