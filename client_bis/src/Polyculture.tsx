  ...
  return (
    <div className={styles['polyculturePageContainer']}>
      ...
      <div className={styles['polycultureContentContainerCol']}>
          <div className={styles['polycultureImgContent']}>
          ...
          <div className={styles['polycultureTextContent']}>
            ...
            <p>
              ...
              woody shrubs, fruit trees, and hardwoods sprout and grow in the shade of the tall maize, progressing
              toward the next stage in the cycle. Some perennial crops are established at this time as well. When the
              woody shrubs ans trees have grown enough to shade annuals, the field advances through successive stages of
              guided reforestation, transforming from an open field into a managed forest (Everton 2012:16-18; Hernàndez
              Xolocotzi et al. 1995:131-139; Livi Tacher and Golicher 2004) “
            </p>
            <p>
              <i>
                From The Maya Forest Garden. Eight millennia of sustainable Cultivation of the tropical woodlands.
                Anabel Ford and Ronald Nigh - 2016 Routledge
              </i>
            </p>
            <p>
            ...
            <p>
              The Maya Forest remains the second most biodiverse place in the world second only to the Amazon forest.
              The Milpa Cycle is the conservation method of farming and managing the Maya forest. It goes through four
              main stages over the course of approximately 20 years.
            </p>
            <p>
              The Milpa Forest Garden system had been selected as the first case study because of the rich availability
              of scientific and non documentation and analysis of each growing phase. It presents a circular finite
              model which frames the research time-wise. It’s a successional, polycultural, agroforestal system, which
              allows the research to analyse a variety of diverse species, from annual to perennial, from weeds to
              trees. For the purpose of the exhibition and to facilitate the initial steps of the research a selection
              of 13 species of flora has been made, the one more recurring in the literature, even if it’s accounted
              that in the Milpa Forest Garden more than 90 species can be found.
            </p>
            <p>
            ...
            <h3>References</h3>
            <p><a href="https://mayaforestgardeners.org/">https://mayaforestgardeners.org/</a></p>
            <p>
              Maya Forest Garden: Eight Millennia of Sustainable Cultivation of the Tropical Woodlands Book by Anabel
              Ford and Ronald Nigh, Routledge 2016
            </p>
