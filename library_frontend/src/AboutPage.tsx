  ...
  <div className={styles['pageContainer']}>
    <div className={`${styles['contentContainer']} ${styles['topMarginContainer']}`}>
      <div className={styles['content']}>
        ...
        <p>
          Programming by Florent Noel <br />
          To see the source code of this library go to{' '}
          <a href="https://github.com/heb-dtc/SyntropicFarming/">https://github.com/heb-dtc/SyntropicFarming/</a>
        </p>
